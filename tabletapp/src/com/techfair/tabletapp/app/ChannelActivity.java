...
public class ChannelActivity extends ConnectedActivity implements ChannelProvider, SensorEventListener {
    ...
    /* (non-Javadoc)
     * @see com.techfair.tabletapp.app.ConnectedActivity#onResume()
     */
    @Override
	...
	/* (non-Javadoc)
	 * @see com.techfair.tabletapp.app.ConnectedActivity#createServiceObserver()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.techfair.tabletapp.app.ChannelProvider#getChannel()
	 */
	@Override
	public Channel getChannel() {
	...
	/* (non-Javadoc)
	 * @see com.techfair.tabletapp.app.ChannelProvider#getChannelUsers()
	 */
	@Override
	public List<User> getChannelUsers() {
	...
	/* (non-Javadoc)
	 * @see com.techfair.tabletapp.app.ChannelProvider#sendChannelMessage(java.lang.String)
	 */
	@Override
	public void sendChannelMessage(String message) {
    ...
    class ChannelServiceObserver extends BaseServiceObserver {
		...
		/* (non-Javadoc)
		 * @see com.techfair.tabletapp.service.BaseServiceObserver#onPermissionDenied(int)
		 */
		@Override
