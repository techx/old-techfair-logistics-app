...
import com.techfair.tabletapp.app.ChannelActivity;
import com.techfair.tabletapp.service.MumbleProtocol.MessageType;
import com.techfair.tabletapp.service.audio.AudioOutputHost;
import com.techfair.tabletapp.service.audio.RecordThread;
...
public class MumbleService extends Service {
	...
	class ServiceProtocolHost extends AbstractHost implements
		...
		/* (non-Javadoc)
		 * @see com.techfair.tabletapp.service.MumbleProtocolHost#permissionDenied(net.sf.mumble.MumbleProto.PermissionDenied.DenyType, net.sf.mumble.MumbleProto.PermissionDenied)
		 */
		@Override
